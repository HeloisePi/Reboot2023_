<script>
    ...
    import RetoucheVetement from "../../component/RetoucheVetement.svelte";
</script>

<HeroTheme srcImg="/images/logo/scisor.svg" title="Retoucher ses vêtements :
Lieux et Tutos"></HeroTheme>
<section>
<Contenaire><h2 class="bold">Réparer ses vêtements, la mode intemporelle !</h2>
    <p>C'est le moment de secouer un peu le game de la mode. <br><br>
        Plutôt que de balancer tes fringues, pourquoi pas les réparer ?<br><br>
        On sait tous que la mode va plus vite que la lumière, mais au lieu de suivre le rythme, pourquoi ne pas ralentir et donner une seconde vie à ton jean préféré? Un coup de couture par-ci, un remplacement de bouton par-là, et bam le tour est joué.<br><br>
        Réparer, c'est pas juste économique, c'est un geste rebelle contre la surconsommation. <br><br>
        <span class="bold">Retrouve juste ici quelques retoucheurs sur Bordeaux !</span></p>
    </Contenaire>
    ...
    <div class="">
        ...
        <div class="allButton">
            ...
            <ThemeButton src="../sevetir/seconde-main" logo="/images/logo/eco.svg">RL’esprit “Seconde main”</ThemeButton>
        </div>
    </div>
